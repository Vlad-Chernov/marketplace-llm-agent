...
В измеренном LangGraph-прогоне 12 карточек израсходовали 48 484 токена — в
среднем около 4 040 токенов на карточку с учётом повторных попыток. При цене
500 ₽ за 1 млн токенов:

| Объём | Оценка токенов | Оценка стоимости |
| --- | ---: | ---: |
| 1 000 товаров | 4,04 млн | около 2 020 ₽ |
| 100 000 товаров | 404,03 млн | около 202 017 ₽ |
