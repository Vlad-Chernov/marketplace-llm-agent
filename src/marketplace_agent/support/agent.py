            ...
            *history,
            Message(
                ...
                content=(
                    ...
                    "Исключение — явное противоречие в истории: в этом случае "
                    "Если в истории есть противоречивые утверждения о факте, "
                    "не выбирай, какое из них истинно: верни final со статусом "
                    "needs_clarification и задай один короткий уточняющий "
                    "вопрос. Не эскалируй такой случай. "
                    "Не добавляй юридические выводы или условия, которых нет "
                    "в результате инструмента или правилах. "
